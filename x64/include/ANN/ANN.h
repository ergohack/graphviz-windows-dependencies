...
public:
	...
	virtual size_t theDim() = 0;			// return dimension of space
	virtual size_t nPoints() = 0;			// return number of points
...
public:
	...
	size_t theDim()						// return dimension of space
		{ return dim; }

	size_t nPoints()						// return number of points
		{ return n_pts; }
